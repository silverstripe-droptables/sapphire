<div class="cms-navigator">
    ...
    <span class="preview-selector field dropdown">
		<select title="<% _t('SilverStripeNavigator.ViewDeviceWidth', 'View at device width') %>" id="cms-preview-mode-dropdown" class="preview-dropdown dropdown nolabel" autocomplete="off" name="Action">
